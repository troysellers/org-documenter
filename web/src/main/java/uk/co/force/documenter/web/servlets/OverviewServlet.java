...
import uk.co.force.documenter.utils.RestUtil;
...
public class OverviewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		retval.put("sobjects", restUtil.getJSONObject(authSession.getString(Constants.ACCESS_TOKEN), sobjectUrl, client));
		...
		retval.put("apexManifest", restUtil.getJSONArray(authSession.getString(Constants.ACCESS_TOKEN), apexManifestUrl, client));
